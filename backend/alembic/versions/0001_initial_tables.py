...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("runtime",        sa.Integer(), nullable=True),   # minutes
        ...
        # Images
        sa.Column("poster_path",    sa.String(500), nullable=True),   # TMDb path e.g. /abc.jpg
        sa.Column("backdrop_path",  sa.String(500), nullable=True),
        sa.Column("local_poster_path", sa.String(500), nullable=True), # cached local file

        # People (denormalised for v1 simplicity)
        sa.Column("director",       sa.String(300), nullable=True),
        sa.Column("cast_top5",      sa.Text(), nullable=True),        # JSON array string
    ...
    op.create_table(
        ...
        # User data
        sa.Column("rating",          sa.Float(), nullable=True),           # 0.5 – 10.0
        sa.Column("notes",           sa.Text(), nullable=True),
        sa.Column("review",          sa.Text(), nullable=True),
        sa.Column("is_favorite",     sa.Boolean(), default=False, nullable=False, server_default=sa.false()),
        sa.Column("is_watchlisted",  sa.Boolean(), default=False, nullable=False, server_default=sa.false()),
        sa.Column("watched",         sa.Boolean(), default=True,  nullable=False, server_default=sa.true()),

        # Watch dates (convenience — full history in watch_events)
    ...
    op.create_index("ix_entries_updated_at","entries", ["updated_at"])   # sync performance
    ...
    op.create_table(
        ...
        sa.Column("platform",    sa.String(100), nullable=True),     # e.g. "Netflix", "Cinema"
        sa.Column("notes",       sa.Text(), nullable=True),
        sa.Column("created_at",  sa.DateTime(), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("is_public",     sa.Boolean(), default=False, nullable=False, server_default=sa.false()),
    ...
    op.create_table(
        "tmdb_cache",
        sa.Column("id",          sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column("cache_key",   sa.String(300), unique=True, nullable=False),  # e.g. "movie_550" or "search_fight+club"
        sa.Column("data_json",   sa.Text(), nullable=False),
        sa.Column("fetched_at",  sa.DateTime(), server_default=sa.func.now(), nullable=False),
        sa.Column("expires_at",  sa.DateTime(), nullable=True),                  # fetched_at + 30 days
    )
